...
vi.mock("@/lib/actions/bookings", () => ({
  checkInAction: vi.fn(), checkOutAction: vi.fn(), sendPaymentLinkAction: vi.fn(), markPaidAction: vi.fn(), cancelAction: vi.fn(),
}));

import { BookingDetailView, type BookingDetailData } from "./BookingDetailView";

const data: BookingDetailData = {
  id: "b1", ref: "SK-CO2405", state: "unpaid",
  room: { number: "302", name: "Western Ghats" },
  guest: { id: "g5", name: "Daniel Müller", city: "Berlin", phone: "+49", email: null, isForeign: true, idType: null, idLast4: null, stays: 1 },
  checkIn: "12 Jun", checkOut: "17 Jun", checkInTime: "14:00", checkOutTime: "11:00",
  nights: 5, adults: 2, children: 0, channel: { key: "booking", name: "Booking.com" },
  money: { subtotal: "₹ 39,750", tax: "₹ 0", total: "₹ 39,750", paid: "₹ 0", due: "₹ 39,750", dueRaw: 3975000, taxLabel: "No GST (owner unregistered)", nightly: "₹ 7,950" },
  payments: [], comms: [], audit: [], notes: null,
};
