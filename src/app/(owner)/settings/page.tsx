            ...
            <div className="card card-padded">
              ...
              <div className="kv-grid">
                <div className="kv">
                  ...
                  <div className="v">{property.name}</div>
                </div>
                <div className="kv">
                ...
                <div className="kv">
                  ...
                  <div className="v">{property.gstin ?? "Not registered"}</div>
                </div>
                <div className="kv">
                  <div className="k">SAC code</div>
                  <div className="v">{property.sacCode}</div>
                </div>
                <div className="kv">
                  <div className="k">Check-in / out</div>
                  <div className="v">
                    {property.checkInTime} / {property.checkOutTime}
                  </div>
                </div>
                <div className="kv">
                  <div className="k">Invoice prefix</div>
                  <div className="v">{property.invoicePrefix}</div>
                </div>
              </div>
            </div>
          )}
