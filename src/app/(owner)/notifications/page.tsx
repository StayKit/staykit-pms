...
const CHANNEL_TAG: Record<"SMS" | "EMAIL" | "WHATSAPP", string> = {
  SMS: "",
  EMAIL: "direct",
  WHATSAPP: "whatsapp",
};
...
export default async function NotificationsPage() {
  ...
  for (const t of templates) {
    const prev = byTrigger.get(t.triggerKey) ?? {
      name: t.name,
    ...
    <div className="page" style={{ paddingTop: 16 }}>
      ...
      <div className="card">
        <div className="card-header">
          ...
          <div className="sub" style={{ marginLeft: "auto" }}>
            {rows.length} active · 3 channels · {sent30} sent (30d)
          </div>
        </div>
        <table className="tbl">
          <thead>
      ...
      <div className="checklist-card" style={{ marginTop: 24 }}>
        ...
        <div className="text">
          ...
          <div className="sub">
            Filter guests by stay date or property, then send a WhatsApp or email.
          </div>
        </div>
